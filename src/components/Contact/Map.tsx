        ...
        <div className="p-5 py-10 lg:p-20 bg-white space-y-10">
          ...
          <div className="grid md:grid-cols-3 gap-10 items-center justify-center">
            <div className="flex space-x-3 items-center">
              <ImLocation2 className="w-28 h-28 p-5 border-r border-gary-100" />
            ...
            <div className="flex space-x-3 items-center">
              <MdPhoneIphone className="w-28 h-28 p-5 border-r border-gary-100" />
              <div className="flex flex-col space-y-3">
            ...
            <div className="flex space-x-3 items-center">
              <FiMail className="w-28 h-28 p-5 border-r border-gary-100" />
              <div className="flex flex-col space-y-3">
