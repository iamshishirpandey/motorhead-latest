    ...
    <div className="bg-zinc-200 rounded-md overflow-hidden w-full">
      ...
      >
        <div className="bg-white rounded-sm md:w-3/4 p-4">
          <div className="flex flex-col items-start md:pl-5 p-5 md:py-10 space-y-5">
            <div className="hover:text-red-700 font-medium text-left text-xl">
              MOTORHEAD Motorcycle
            </div>
            <p className="text-left text- text-gray-500">
              MotorHead Motorcycle Showroom Opened in Pokhara - Magh 1,
              2076.Pokhara Showroom Opening Ceremony
            </p>
            <button className="shadow bg-zinc-200 rounded hover:bg-red-700 hover:text-white transition duration-300 ease-in  flex items-center space-x-2">
              <span
              ...
              <span className=" px-3 font-semibold ">READ MORE</span>
            </button>
          </div>
        </div>
      </div>
